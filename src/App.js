...
class DialogDemo1 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
...
class DialogDemo2 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
    this.handleOpenDialog = this.handleOpenDialog.bind(this);
...
class DialogDemo3 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
    this.handleOpenDialog = this.handleOpenDialog.bind(this);
    ...
    return (
      <div className="App">
        <div className="App-header">
          ...
          <h3>React-MDL Component Test</h3>
